...
\author{\IEEEauthorblockN{1\textsuperscript{st}  Alexey Tikhomirov}
...
\IEEEauthorblockA{\ }
\and
\IEEEauthorblockN{4\textsuperscript{th} Arman Petrosyants}
\IEEEauthorblockA{\textit{Bauman Moscow State Technical} \\
\textit{University}\\
Moscow, Russia \\
...
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }
\and
\IEEEauthorblockN{5\textsuperscript{th} Sergey Shchukin}
\IEEEauthorblockA{\textit{Bauman Moscow State Technical} \\
\textit{University}\\
Moscow, Russia \\
0000-0002-9890-5267}
